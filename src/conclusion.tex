...
We lay out the results of this thesis' algorithms and provide a series of conjectures based on them.
...
\note{Here I want to provide a table of LOCC operations that can change rank-width. These are meant to be used as a basis to conjecture what to add to local Pauli measurements, local Cliffords, and classical communication.}