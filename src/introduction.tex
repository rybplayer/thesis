...
The measurement-based quantum computation (MBQC) model is of particular interest. This is because MBQC collapses any quantum circuit into measurements of a highly-entangled resource state that can be prepared in constant depth. This is quite shocking, as no clear classical counterpart exists. The cost of this model, however, is that measurements need to be adaptive. In other words, some post-processing must be done on-the-fly to determine what qubits should be measured next and how.
