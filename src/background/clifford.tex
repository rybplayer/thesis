...
\begin{enumerate}[label=(\alph*)]
    ...
    \item There are no self loops or parallel / duplicate edges.
...
\begin{example}
The triangle graph has the following circuit and ZX graph state:
...
\begin{align}
    \begin{ZX}
    \leftManyDots{} \zxZ{\alpha} \rar & \zxX{} \rar & \zxZ{} \dar \rar & \\
    \leftManyDots{} \zxZ{\beta} \rar \ar[ur] & \zxX{} \rar & \zxX{} \rar & \\
    \leftManyDots{} \zxZ{\gamma} \ar[ur] & &
    \end{ZX}
    =
    \begin{ZX}
    \leftManyDots{} \zxZ{\alpha} \rar & \zxX{} \rar & \rar & \\
    \leftManyDots{} \zxZ{\beta} \rar & \zxX{} \rar & \rar & \\
    \leftManyDots{} \zxZ{\gamma} \ar[ur] \ar[uur] & &
    \end{ZX}
\end{align}
